...
const SingleToast: React.FC<{ toast: ToastItem; onClose: () => void }> = ({ toast, onClose }) => {
  ...
  const typeIcons: Record<ToastType, JSX.Element> = {
    info: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9FB8D8" strokeWidth="2">
    ...
    success: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4E8770" strokeWidth="2">
        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
        <polyline points="22 4 12 14.01 9 11.01" />
      </svg>
    ),
    warning: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C49E58" strokeWidth="2">
    ...
    error: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C26B6B" strokeWidth="2">
        <circle cx="12" cy="12" r="10" />
